...
export default function Page() {
  ...
  return (
    <section className='min-h-full px-8 py-8 md:px-36 md:py-28 md:space-y-12 lg:max-w-lg lg:mx-auto lg:p-0'>
      <div className='flex flex-1 flex-col justify-center space-y-14 lg:mt-20'>
        <AuthHeader />
