const Component: React.FC<{ id?: string, children?: any, variant?: string, type?: "submit" | "reset" | "button", handleClick?: () => void, disabled?: boolean }> = ({ id, children, variant, type, handleClick, ...props }) => {
  return (
    <>
      {variant === 'secondary' ?
        <button
